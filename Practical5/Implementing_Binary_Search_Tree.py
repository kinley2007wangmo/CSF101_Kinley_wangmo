...
#   Step 5: Implement the Traversal Methods
    ...
    def preorder_traversal(self):            #Implement Preorder Traversal
        result = []
    ...
    def postorder_traversal(self):              #Implement Postorder Traversal
        result = []
...
#   Step 6: Implement the Deletion Method
    ...
    def delete(self, value):                    #Implement the Deletion Method
